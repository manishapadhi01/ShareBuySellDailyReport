...
public class RankInstructionsOnOutgoingTest {

	@Test
	public void testRankInstructionsOnOutgoing() {
		...
		Entity entity3 = new Entity("test", "7873484343");
		...
		Calendar settlementDate2 = new GregorianCalendar(2017, 3, 18);
		Calendar incomingDate3 = new GregorianCalendar(2017, 3, 23);
		Calendar settlementDate3 = new GregorianCalendar(2017, 3, 18);
		...
		instructionBuilder.createInstruction(entity2, Indicator.BUY, 0.25, Currency.AED, incomingDate2, settlementDate2,
				200, 67.89);
		instructionBuilder.createInstruction(entity3, Indicator.BUY, 0.25, Currency.AED, incomingDate3, settlementDate3,
				200, 20.78);
		...
		InstructionList sortedList = report.rankInstructionsOnOutgoing();
