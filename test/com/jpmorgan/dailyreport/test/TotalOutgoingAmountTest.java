 ...
 *
 */
public class TotalOutgoingAmountTest {

	@Test
	public void testOutgoingAmountForToday() {
		...
		assertEquals(6789.00, amount.get("outgoingAmount"), 0.0);
		assertNotEquals(3394.50, amount.get("outgoingAmount"), 0.0);
	}
